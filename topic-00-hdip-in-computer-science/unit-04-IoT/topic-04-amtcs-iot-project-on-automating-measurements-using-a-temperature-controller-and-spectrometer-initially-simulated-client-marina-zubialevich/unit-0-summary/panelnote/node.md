...
<img src="img/poster.jpeg" alt="AMTCS - IoT project on Automating measurements using a temperature controller and spectrometer, initially simulated (client Poster" style="float: right; height: auto; max-height: 100vh; max-width: 65%; margin-left: 20px; margin-bottom: 20px;">
...
|-------|-------|
| **Project Number** | 19 |
| **Student Name** | Marina Zubialevich |
| **Student Number** | 20108904 |
| **Supervisor** | Kealy, Anita |
| **Project Title** | AMTCS - IoT project on Automating measurements using a temperature controller and spectrometer, initially simulated (client |
| **Landing Page** | https://zumavla.github.io/AMTCS-System |
| **Project Type** | IOT |
