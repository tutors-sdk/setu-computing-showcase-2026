<img src="img/poster.jpeg" alt="CoRaw Poster" style="float: right; height: auto; max-height: 100vh; max-width: 50%; margin-left: 20px; margin-bottom: 20px;">
<div style="max-width: 35%; float: left;">


<img src="img/profile.jpeg" alt="Oisin Larkin" style="float: left; width: 150px; border-radius: 10px; margin-right: 20px; margin-bottom: 20px;">
...
|-------|-------|
| **Project Number** | 23 |
| **Student Name** | Oisin Larkin |
| **Student Number** | 20108906 |
| **Supervisor** | Mc Mahon, Michael |
| **Project Title** | CoRaw |
| **Landing Page** | https://bit.ly/47h7xDa |
| **Project Type** | Web App / AI |
