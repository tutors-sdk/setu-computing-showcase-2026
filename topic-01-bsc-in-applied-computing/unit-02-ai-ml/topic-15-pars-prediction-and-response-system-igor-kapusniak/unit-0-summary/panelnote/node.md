# {PARS}-Prediction and Response System - Igor Kapusniak

<img src="img/poster.jpeg" alt="{PARS}-Prediction and Response System Poster" style="float: right; height: auto; max-height: 100vh; max-width: 50%; margin-left: 20px; margin-bottom: 20px;">
...
|-------|-------|
| **Project Number** | 15 |
| **Student Name** | Igor Kapusniak |
| **Student ID** | W20102236 |
| **Supervisor** | Jason Berry |
| **Project Title** | {PARS}-Prediction and Response System |
| **Landing Page** | https://t25623.github.io/ |
