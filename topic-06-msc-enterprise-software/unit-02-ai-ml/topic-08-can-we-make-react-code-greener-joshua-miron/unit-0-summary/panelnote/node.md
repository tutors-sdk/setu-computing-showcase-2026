...
<img src="img/profile.jpeg" alt="Joshua Miron" style="float: left; width: 150px; border-radius: 10px; margin-right: 20px; margin-bottom: 20px;">

## Can We Make React Code Greener - Joshua Miron
...
|-------|-------|
| **Project Number** | 111 |
| **Student Name** | Joshua Miron |
| **Student ID** | W20104476 |
| **Supervisor** | Dr Siobhan Drohan |
| **Project Title** | Can We Make React Code Greener |
| **Landing Page** | https://github.com/joshuamiron/green-patterns-vite |
