...
<img src="img/profile.jpeg" alt="Krishna Rajakumar" style="float: left; width: 150px; border-radius: 10px; margin-right: 20px; margin-bottom: 20px;">

## LLMs for Safer Passwords - Krishna Rajakumar
...
|-------|-------|
| **Project Number** | 117 |
| **Student Name** | Krishna Rajakumar |
| **Student ID** | W20115525 |
| **Supervisor** | Dr John Sheppard |
| **Project Title** | LLMs for Safer Passwords |
| **Landing Page** | https://github.com/krishna-rajakumar/PII-Passwords |
