...
|-------|-------|
| **Project Number** | 134 |
| **Student Name** | Jhansi Veeravalli |
| **Student ID** | W20115932 |
| **Supervisor** | Dr Mujahid Tabassum |
| **Project Title** | AI-Based Network Fault Prediction |
| **Landing Page** | https://github.com/JhansiVeeravalli/AI-Driven-Network-fault-prediction.git |
