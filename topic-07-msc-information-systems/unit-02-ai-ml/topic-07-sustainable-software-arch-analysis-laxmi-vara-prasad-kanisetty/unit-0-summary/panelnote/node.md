...
|-------|-------|
| **Project Number** | 125 |
| **Student Name** | Laxmi Vara Prasad Kanisetty |
| **Student ID** | W20115497 |
| **Supervisor** | Liam Doyle |
| **Project Title** | Sustainable Software Arch Analysis |
| **Landing Page** | https://github.com/prasad564/Energy-Efficiency-Monolith-vs-Microservices |
