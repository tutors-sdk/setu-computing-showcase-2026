...
<img src="img/poster.jpeg" alt="VeriLite – Lightweight File Integrity Poster" style="float: right; height: auto; max-height: 100vh; max-width: 50%; margin-left: 20px; margin-bottom: 20px;">
