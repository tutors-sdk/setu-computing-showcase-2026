...
<img src="img/profile.jpeg" alt="Albert Francis Emmatty" style="float: left; width: 150px; border-radius: 10px; margin-right: 20px; margin-bottom: 20px;">
...
| **Student ID** | W20115913 |
| **Supervisor** | Richie Lyng |
| **Project Title** |  |
| **Landing Page** | https://github.com/albertef/movie-app-research |
